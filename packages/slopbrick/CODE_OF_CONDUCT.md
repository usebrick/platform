...
issues, pull requests, discussions, Discord/Slack channels (if
any), and any other forums the project uses — and also applies
...
may be reported to the community leaders responsible for
enforcement at **conduct@usebrick.dev**. All complaints will be
...
**Consequence**: A temporary ban from any sort of public
