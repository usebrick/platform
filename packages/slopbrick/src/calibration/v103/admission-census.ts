...
function gateSummary(
  ...
  const summary: JsonObject = {
    ...
    searchResultBundleRelativePath: `review/admission/witnesses/${gate}/search-results/${search.bundle.bundleSha256}.json`,
    ...
    ...(review === undefined ? {} : { witnessReviewBundleSha256: review.bundleSha256, witnessReviewBundleRelativePath: `review/admission/witnesses/${gate}/witness-reviews/${review.bundleSha256}.json` }),
