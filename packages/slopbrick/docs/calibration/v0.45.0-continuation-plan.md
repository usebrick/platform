...
sources and 452,382 quarantined units, not admission evidence. The next
ordered action is to build the source-specific immutable projection and recover
the missing generator/rights/lineage evidence, then publish an acquisition-bound
