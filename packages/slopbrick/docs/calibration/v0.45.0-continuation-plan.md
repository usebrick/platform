...
2. release-materialization Task 1 is complete at `ca72d0b15` with exact Core
   gates and independent specification/code-quality approval; continue Tasks
   2-6 test-first and independently review every slice—this tranche is the sole
...
The next implementation task is release-materialization **Task 2**, not corpus
