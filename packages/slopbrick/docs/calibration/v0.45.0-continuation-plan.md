...
- [`v10.3-release-asset-materialization-plan.md`](./v10.3-release-asset-materialization-plan.md),
  SHA-256 `0115a2c73dcfd0a086c70b1e3fe6519558bf7c34ff4942d97d52c3dfa92c585d`;
...
- independent verdict
  `.superpowers/sdd/v103-corpus-admission-plan-final-review.md`.
...
2. release-materialization Tasks 1-2 are complete at `ca72d0b15` and
   `704abef0e` with exact Core/SlopBrick gates and independent
   specification/code-quality approval; continue Tasks 3-6 test-first and
...
The next implementation task is release-materialization **Task 3**, not corpus
