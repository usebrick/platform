...
**Current-state pointer (2026-07-14):** the latest bounded Task 2B prebuilt
byte-backed authority-graph validator checkpoint is recorded below; the
runtime-context source-review anchor is the prior checkpoint. The final
bounded package, validity, threshold, freshness, and self-scan evidence remains
in the `Live verification follow-up` section. Older checkpoint counts remain
