...
parse status; the next scan-UX slice should fix the 0.0s progress ETA and the
200-file persisted inventory/structure versus 240-file health/output count.
