...
**Status:** Historical and superseded for scheduling. Preserve this dated body
as implementation evidence; current authority is
[`docs/execution/index.json`](../../../../docs/execution/index.json),
[`docs/execution/STATUS.md`](../../../../docs/execution/STATUS.md),
[`CORPUS-002`](../../../../docs/execution/plans/CORPUS-002-source-use-routing.md),
and [`VAL-001`](../../../../docs/execution/plans/VAL-001-owner-validation.md).
The v10.3 authority work below is not a prerequisite for the current verified
publisher-attested internal Mendeley evaluation path. Historical counts,
blockers, and next actions below are not current execution instructions.
