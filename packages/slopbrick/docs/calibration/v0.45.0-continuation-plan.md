...
2. release-materialization Tasks 1-3 are complete at `ca72d0b15`,
   ...
   `.superpowers/sdd/v103-release-task4a-review.md`; continue corrected Task 4
   test-first with **4B** exact ZIP dependencies plus raw validator/CRC/receipt/
   reference codecs and **4C** extraction, durable publication, reuse, and
   cleanup; then continue Task 5—this tranche is the sole
...
The next implementation task is release-materialization **Task 4B**, not corpus
