...
- [ ] **G0-01 — Inventory the dirty tree.**
...
- [ ] **G0-02 — Preserve current evidence.**
...
- [ ] **G0-03 — Move work off dirty `main`.**
...
- [ ] recovery branch and reviewed diff inventory
- [ ] v10.2a evidence hash ledger
...
- [ ] **SCORE-03 — Enforce category separation.**
...
- [ ] **CORE-02 — Fix atomic path construction.**
