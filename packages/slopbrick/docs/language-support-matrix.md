...
| Dart | .dart | Blank module + source-preserving facts | dart/* plus shared source-text rules; Dart MCP pattern visitor | All dart/* default-off (DORMANT) | tests/engine/visitors/dart.test.ts; tests/rules/dart | Not eligible for release claims; v10.2 cohort pending |
...
| C / C++ | .c, .h, .cc, .cpp, .cxx, .hpp, .hxx | Blank module + source-preserving facts | cpp/* plus shared source-text rules | cpp/* default-on (HYGIENE/OK) | tests/rules/cpp | Eligible for hygiene; not an AI-authorship claim |
