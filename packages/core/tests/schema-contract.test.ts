...
describe('schema contract and package delivery', () => {
  it('indexes every canonical schema at the exact on-disk path and id', () => {
    const expected = [
      ...
      'calibration-admission-manifest-prerequisites',
      'calibration-admission-manifest-prerequisite-staging-set',
      'calibration-admission-manifest-prerequisite-publication-request',
      'calibration-admission-manifest-prerequisite-publication-lock',
      'calibration-admission-manifest-prerequisite-publication-transaction',
      'calibration-admission-manifest-prerequisite-publication-completion',
      'calibration-admission-manifest-prerequisite-publication-current',
      'calibration-admission-manifest-build-receipt',
      'calibration-admission-manifest-generation',
      'calibration-admission-manifest-current',
      'calibration-admission-manifest-publication-lock',
      'calibration-admission-manifest-publication-transaction',
      ...
      'calibration-release-prerequisite-approval',
      'calibration-score-wire-closure-receipt',
      'calibration-run-lifecycle-receipt',
      'calibration-packed-runtime-receipt',
      ...
      'calibration-admission-cohort-witness',
      'calibration-admission-infeasibility',
      'calibration-admission-search-receipt',
      'calibration-admission-search-result-bundle',
      'calibration-admission-witness-review-receipt',
      'calibration-admission-witness-review-bundle',
      'calibration-admission-census',
      'calibration-admission-witness-routing-reference',
      'calibration-admission-witness-publication-completion',
      'calibration-admission-witness-publication-lock',
      'calibration-admission-witness-publication-transaction',
