...
const COMMANDS: CommandSpec[] = [
  {
    ...
    run: () => [
      ...
      { kind: 'output', text: '  slopbrick init                    create a .slopbrick/ directory' },
      { kind: 'output', text: '  slopbrick rules                   list rule categories' },
      { kind: 'output', text: '  cat .slopbrick/structure.json     show the structure file' },
  ...
  },
  {
    ...
    run: () => [
      ...
      { kind: 'success', text: '✓ done in 1.42s — wrote .slopbrick/structure.json' },
    ],
  },
  {
