...
The next ordered action is generator/rights/lineage evidence recovery against
the persisted projection, followed by an acquisition-bound register delta and
deterministic census. Do not pull more repositories until that census proves a
measured deficit.
