...
`witness_authority_unavailable`. Task 2B has now begun with committed privacy
and quality result/ledger contract slices (`84f787272`, `3996a24d6`);
lineage, pre-witness, context/disposition, and transactional static-authority
work remain open. The next ordered action is to continue Task 2B, then
