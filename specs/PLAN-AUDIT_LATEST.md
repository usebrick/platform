...
`/Users/cheng/corpus-expansion`; one additional Mendeley dataset is persisted
as quarantine-only evidence, while the 12-entry source register is unchanged.
...
The next ordered action is the source-specific immutable projection and
generator/rights/lineage evidence recovery, followed by an acquisition-bound
