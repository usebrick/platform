...
`witness_authority_unavailable`. Task 2B has now begun with the committed
privacy result/ledger contract slice (`84f787272`); quality/lineage,
pre-witness, context/disposition, and transactional static-authority work
