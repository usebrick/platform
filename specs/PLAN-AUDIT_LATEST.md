...
privacy, quality, lineage, and the corrected provisional witness-free
pre-witness boundary (`84f787272`, `3996a24d6`, `61b29fd4b`, `7a9791ebf`; the
historical `593b32b50` shape is superseded); the replay
matches raw diagnostic SHA
`de0cd1879d14365b919c09bdd21bd5760a6804a0e3626d87abf37b78ad948857`, and
the external review-artifact validator remains valid. The frozen rich
`CalibrationAdmissionPreWitnessBundleV1` API, full pre-witness composition,
context/disposition, and transactional static-authority work
remain open. The next ordered action is to continue Task 2B, then
generator/rights/lineage evidence, followed by an acquisition-bound register
delta and deterministic census. Do not pull more repositories until that
census proves a measured deficit. The mechanical dependency rereview rebind is recorded in
