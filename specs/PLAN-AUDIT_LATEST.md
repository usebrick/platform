...
| **Current continuation-plan hash override (2026-07-15)** | `088a4d9a2dadfeb3f94e1807d8a73819958b3d6767bee7f294c0fb0732de41d2` | Supersedes the historical continuation-plan hash in the frozen row below after the current corpus/control-plane, CLI-boundary, candidate-context/preview, report-publication, recursive-gate, self-scan, bounded-verification, policy-status UX, live census-preview, adapter review, and transaction-owned staging update. |
